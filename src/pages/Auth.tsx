...
import { GraduationCap, Mail, Lock, User, LogIn } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-foreground">Avaliação Diagnóstica</h1>
          <p className="text-muted-foreground text-sm">Plataforma de avaliação educacional</p>
        </div>
              ...
              {!isLogin && (
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" placeholder="Seu nome" value={name} onChange={(e) => setName(e.target.value)} className="pl-9" required />
                  </div>
                </div>
              )}
              <div className="space-y-1.5">
